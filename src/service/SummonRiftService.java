...
public class SummonRiftService {
    public SummonRift createMatch(Scanner scanner, TeamService teamService, FigureService figureService, ArrayList<Figure> figures1, ArrayList<Figure> figures2, ArrayList<Team> team1, ArrayList<Team> team2) {
        ...
        for (int i = 0; i < 2; i++) {
            if (i == 0) {
                ...
                Team team = teamService.createTeam(scanner, figureService, figures1);  //Khởi tạo 1 team bao gồm ... tướng
                team1.add(team);    //Thêm 1 team vào mảng các team (teams)
            }
            else {
                //figures.clear();
                System.out.println("======= Thông tin team thứ " + (i + 1) + " ========");
                Team team = teamService.createTeam(scanner, figureService, figures2);  //Khởi tạo 1 team bao gồm ... tướng
